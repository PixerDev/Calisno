...
class ActivitySlideWidget extends StatelessWidget {
  const ActivitySlideWidget(
      {super.key,
      required this.imagePath,
      required this.title,
      required this.subtitle,
      required this.ontap,
      required this.slideActivityLevel,
      required this.activityLevel});
  final String imagePath;
  final String title;
  final String subtitle;
  final VoidCallback ontap;
  final ActivityLevel slideActivityLevel;
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
                colors: slideActivityLevel == activityLevel
